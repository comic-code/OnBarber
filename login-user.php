...
<body>
	...
	?>
	<div class="msg erro">
		<p>É necessário o preenchimento dos campos.</p>
	</div>		
	<?php
    endif;
	...
	<div id="caixa-login"> <!-- início caixa -->
		<form id="form-login" action="controller/logar-usuario.php" method="POST"> <!-- início form login -->
				...
				<div> <!-- div usuário -->
					<input type="text" name="email" id="email" placeholder="Email" class="icon-user">
				</div> <!-- fim usuário -->
